...
// Enviar ubicación al server (sin modificar server.js)
...
export default function MapMapLibre() {
    ...
    // Bug móvil — si el usuario movió el mapa manualmente, no lo forzamos a seguir GPS
    ...
    // Modo oscuro automático por hora
    useEffect(() => {
    ...
    // Enviar ubicación al server cada 15 segundos
    useEffect(() => {
        if (!ubicacion) return;
